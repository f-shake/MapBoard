...
namespace MapBoard.IO
{
    public static class Exporter
    {
        ...
        public static Task ExportGeoJsonAsync(string path, IMapLayerInfo layer, IEnumerable<Feature> features = null)
        {
            return ExportLayerAsync(new GeoJson(false), path, layer, features);
        }

        public static Task ExportGeoJsonWithStylesAsync(string path, IMapLayerInfo layer, IEnumerable<Feature> features = null)
        {
            return ExportLayerAsync(new GeoJson(true), path, layer, features);
        }

        public static Task ExportKmlAsync(string path, IMapLayerInfo layer, IEnumerable<Feature> features = null)
        {
            return ExportLayerAsync(new Kml(), path, layer, features);
        }

        public static Task ExportKmlAsync(string path, IEnumerable<IMapLayerInfo> layer)
        {
            return ExportMapAsync(new Kml(), path, layer);
        }
